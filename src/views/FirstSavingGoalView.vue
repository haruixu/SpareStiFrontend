<template>
    <div class="flex flex-col items-center justify-start min-h-screen px-4 text-center">
        <div class="mb-20">
            <div class="flex flex-col items-center justify-start bg-white shadow-md rounded-lg p-16 min-h-[500px] min-w-[400px] max-w-[400px]">
                ...
                canAccept ? 'bg-[var(--green)] hover:brightness-90 active:brightness-75' : 'opacity-60 bg-gray-300 cursor-not-allowed'
              ]"
                            :disabled="!canAccept"
                            @click="accept"
                        >
