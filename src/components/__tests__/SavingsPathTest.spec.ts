...
describe('SavingsPathComponent', () => {
    ...
    describe('InitialRender', () => {
        it('shouldrenderchallengeandgoaldetailscorrectly', async () => {
            ...
            expect(challengeText).toContain(
                'Din Sparesti  Ufullførte utfordringer↓ ️ Testchallenge100kr / 1000kr  + 20kr på Testchallenge + Legg til Spareutfordring Ditt neste sparemål🤩: Testgoal Endre mål 100kr / 1000kr'
            )
